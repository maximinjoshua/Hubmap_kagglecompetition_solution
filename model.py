...
from mit import *
import numpy as np
from transformers import SegformerFeatureExtractor, SegformerForSemanticSegmentation, SegformerForImageClassification
...
class SegformerDecoder(nn.Module):
	...
	def forward(self, feature):
		...
		out = []
		# print('feature_before', feature)
		# print('feature_shape', len(feature))
		# print('feature_inside', feature[0].shape)
		# print('feature_inside1', feature[1])
		# print('feature_inside2', feature[2])
		# print('feature_inside3', feature[3])
...
class Net(nn.Module):
	def load_pretrain( self,):
		...
		# self.encoder = SegformerForImageClassification.from_pretrained("nvidia/mit-b2")
	...
	def forward(self, batch):
		...
		if 'loss' in self.output_type:
			...
			# print('logit_unique',logit.unique())
